...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        UnlimTP unlimited_XS = new UnlimTP("unlimited_XS", 2314, Integer.MAX_VALUE, 1, 8.90);
        UnlimTP unlimited_S = new UnlimTP("unlimited_S", 1234, Integer.MAX_VALUE, 2, 12.90);
        UnlimTP unlimited_M = new UnlimTP("unlimited_M", 2242, Integer.MAX_VALUE, 4, 17.90);
